...
save(SMRCross,file = "./outputs/rSMR_aSMR_Model_long.RData")
...
Spp <- c("ABIEAMA", "ABIEGRA","ABIELAS", "CHAMNOO", "JUNISCO", "LARIOCC", "PINUCON", "PINUMON", "PINUPON","PICEENE", "PICEMAR",  "PICESIT","PSEUMEN", "THUJPLI","TSUGHET", "TSUGMER")
