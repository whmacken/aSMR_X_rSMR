...
# ##--------BGCs requiring special adjustments for deep snowpack
    ...
    CMD <- full_join(CMD,BGC_Special, by = c("ID2" = "BGC"))
...
rules <- read.csv("./inputs/aSMR_Rules_HalfStep_v12_30Dec2021.csv") ### import rules on range of CMD which equates to aSMR
